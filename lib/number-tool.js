...
(function (global) {
  ...
  function deepVegaConfig() {
    ...
    var fg = (cs.getPropertyValue('--fg') || '#1a1a1a').trim();
    ...
    return {
      ...
      legend: { labelColor: mute, titleColor: mute, labelFontSize: 10, titleFontSize: 11 },
  ...
  var DEEP_WEBGL = { fuel: 1, ratio: 1, exposure: 1, combo: 1, bayes: 1 };
        ...
        '<div class="inner">' +
          ...
          '<div class="fields">' +
            ...
            '<fieldset><legend>keys</legend><p class="keys-hint">' +
              ...
              '<br>chart cell: tab to focus · <kbd>↑</kbd><kbd>↓</kbd> nudge · <kbd>⇧</kbd> = coarse' +
