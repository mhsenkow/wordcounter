...
(function (global) {
        ...
        '<div class="inner">' +
          ...
          '<div class="fields">' +
            ...
            '<fieldset><legend>keys</legend><p class="keys-hint">' +
              ...
              '<br>trackpad scroll nudges value · <kbd>⇧</kbd> fast · pinch coarse · arrows on focused field' +
            '</p></fieldset>' +
          '</div>' +
        '</div>' +
      '</div>';
  ...
  /**
   * Trackpad gestures: vertical/horizontal wheel + pinch (ctrl+wheel).
  ...
  function syncStageBounds() {
    ...
    if (!found) return;
    var padB = Math.max(140, Math.round(window.innerHeight - top + 10));
