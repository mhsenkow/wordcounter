...
cp "$ROOT/lib/deep-viz.js" "$ROOT/lib/vega.min.js" "$ROOT/lib/vega-lite.min.js" "$ROOT/lib/vega-embed.min.js" "$ROOT/lib/regl.min.js" "$PORT/lib/" 2>/dev/null || true
...
if [[ "$DO_FTP" -eq 1 ]]; then
  ...
  upload "$ROOT/lib/deep-viz.js" "${BASE}/lib/deep-viz.js"
  upload "$ROOT/lib/vega.min.js" "${BASE}/lib/vega.min.js"
  upload "$ROOT/lib/vega-lite.min.js" "${BASE}/lib/vega-lite.min.js"
  upload "$ROOT/lib/vega-embed.min.js" "${BASE}/lib/vega-embed.min.js"
  upload "$ROOT/lib/regl.min.js" "${BASE}/lib/regl.min.js"
